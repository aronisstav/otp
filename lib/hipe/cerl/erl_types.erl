...
t_from_form({type, _L, arity, []}, _TypeNames, _ET, _M, _MR, _V) ->
  t_arity();
t_from_form({type, _L, array, []}, TypeNames, ET, M, MR, V) ->
  builtin_type(array, t_array(), TypeNames, ET, M, MR, V);
...
t_from_form({type, _L, char, []}, _TypeNames, _ET, _M, _MR, _V) ->
  t_char();
t_from_form({type, _L, dict, []}, TypeNames, ET, M, MR, V) ->
  builtin_type(dict, t_dict(), TypeNames, ET, M, MR, V);
t_from_form({type, _L, digraph, []}, TypeNames, ET, M, MR, V) ->
  builtin_type(digraph, t_digraph(), TypeNames, ET, M, MR, V);
...
t_from_form({type, _L, 'fun', [{type, _, product, Domain}, Range]},
  ...
  T = t_from_form(Range, TypeNames, ET, M, MR, V),
  t_fun(L, T);
t_from_form({type, _L, gb_set, []}, TypeNames, ET, M, MR, V) ->
  builtin_type(gb_set, t_gb_set(), TypeNames, ET, M, MR, V);
t_from_form({type, _L, gb_tree, []}, TypeNames, ET, M, MR, V) ->
  builtin_type(gb_tree, t_gb_tree(), TypeNames, ET, M, MR, V);
...
t_from_form({type, _L, product, Elements}, TypeNames, ET, M, MR, V) ->
  ...
  t_product(L);
t_from_form({type, _L, queue, []}, TypeNames, ET, M, MR, V) ->
  builtin_type(queue, t_queue(), TypeNames, ET, M, MR, V);
...
t_from_form({type, _L, reference, []}, _TypeNames, _ET, _M, _MR, _V) ->
  t_reference();
t_from_form({type, _L, set, []}, TypeNames, ET, M, MR, V) ->
  builtin_type(set, t_set(), TypeNames, ET, M, MR, V);
t_from_form({type, _L, string, []}, _TypeNames, _ET, _M, _MR, _V) ->
  t_string();
t_from_form({type, _L, term, []}, _TypeNames, _ET, _M, _MR, _V) ->
  t_any();
t_from_form({type, _L, tid, []}, TypeNames, ET, M, MR, V) ->
  builtin_type(tid, t_tid(), TypeNames, ET, M, MR, V);
